    ...
    <div class="container-fluid">
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0" style="font-weight: 600;display: flex; align-items: center;">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="../../../../learn_mvc/quanLyPhong">Quản lý phòng</a>
                </li>

                <li class="nav-item">
                    <a class="nav-link" href="../../../../learn_mvc/quanLyDichVu">Quản lý dịch vụ</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="../../../../learn_mvc/quanLyKhachHang">Quản lý khách hàng</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="../../../../learn_mvc/quanlynhanvien">Quản lý nhân viên</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="../../../../learn_mvc/quanlydoanhthu">Quản lý doanh thu</a>
                </li>

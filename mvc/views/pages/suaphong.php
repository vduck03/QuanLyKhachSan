        ...
        <div class="modal-content" style="padding: 20px; background-color: white; border-radius: 10px; box-shadow: rgba(100, 100, 111, 0.2) 0px 7px 29px 0px;">
            ...
            <div class="modal-body">
                ...
                ?>
                    ...
                    <input name="tenphong" style="margin-top: 6px; margin-bottom: 20px;" value="<?php echo  $room[0] ?>" type="text" class="form-control" aria-label="" aria-describedby="basic-addon1">
